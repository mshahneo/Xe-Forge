...
module @fa attributes {gpu.container_module} {
  gpu.module @payload_kernel [#xevm.target<O = 3>] {
    gpu.func @payload_kernel(%arg0: memref<16x4096x64xf16>, %arg1: memref<2x8x4096x64xf16>, %arg2: memref<2x8x4096x64xf16>, %arg3: memref<2x8x4096x64xf16>, %arg4:memref<2x8x4096x64xf16>) kernel attributes {known_block_size = array<i32: 128, 1, 1>, known_grid_size = array<i32: 16, 32, 1>} {
      ...
      %18:3 = scf.for %arg5 = %c0 to %c4096 step %c64 iter_args(%arg6 = %cst_0, %arg7 = %cst_1, %arg8 = %cst_2) -> (vector<128xf16>, vector<128x64xf16>, vector<128xf16>) {
        ...
        %34 = xegpu.dpas %31, %33, %cst_1 <{layout_a = #xegpu.layout<sg_layout = [8, 1], sg_data = [16, 64], inst_data = [8, 16]>, layout_b = #xegpu.layout<sg_layout = [1, 8], sg_data = [64, 64], inst_data = [16, 16], order = [0, 1]>, layout_cd = #xegpu.layout<sg_layout = [8, 1], sg_data = [16, 64], inst_data = [8, 16]>}> : vector<128x64xf16>, vector<64x64xf16>, vector<128x64xf16> -> vector<128x64xf16>
        %35 = arith.mulf %34, %cst : vector<128x64xf16>
        %36 = vector.multi_reduction <maximumf>, %35, %arg8 [1] : vector<128x64xf16> to vector<128xf16>
        %37 = arith.subf %cst_0, %36 : vector<128xf16>
        %38 = math.exp %37 : vector<128xf16>
        %39 = arith.subf %cst_0, %arg8 : vector<128xf16>
        %40 = math.exp %39 : vector<128xf16>
        %41 = arith.divf %38, %40 : vector<128xf16>
        %42 = vector.broadcast %41 : vector<128xf16> to vector<64x128xf16>
        %43 = vector.transpose %42, [1, 0] : vector<64x128xf16> to vector<128x64xf16>
        %44 = arith.mulf %arg7, %43 : vector<128x64xf16>
        %45 = vector.broadcast %36 : vector<128xf16> to vector<64x128xf16>
        %46 = vector.transpose %45, [1, 0] : vector<64x128xf16> to vector<128x64xf16>
        %47 = arith.subf %35, %46 : vector<128x64xf16>
        %48 = math.exp %47 : vector<128x64xf16>
        ...
        %50 = xegpu.dpas %48, %49, %44 <{layout_a = #xegpu.layout<sg_layout = [8, 1], sg_data = [16, 64], inst_data = [8, 16]>, layout_b = #xegpu.layout<sg_layout = [8, 1], sg_data = [64, 64], inst_data = [16, 16]>, layout_cd = #xegpu.layout<sg_layout = [8, 1], sg_data = [16, 64], inst_data = [8, 16]>}> : vector<128x64xf16>, vector<64x64xf16>, vector<128x64xf16> -> vector<128x64xf16>
        %51 = arith.mulf %arg6, %41 : vector<128xf16>
        %52 = vector.multi_reduction <add>, %48, %51 [1] : vector<128x64xf16> to vector<128xf16>
        scf.yield %52, %50, %36 : vector<128xf16>, vector<128x64xf16>, vector<128xf16>
      }
      %19 = vector.broadcast %18#0 : vector<128xf16> to vector<64x128xf16>
      %20 = vector.transpose %19, [1, 0] : vector<64x128xf16> to vector<128x64xf16>
      %21 = arith.divf %18#1, %20 : vector<128x64xf16>
